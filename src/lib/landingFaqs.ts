...
export const fallbackLandingFaqGroups: LandingFaqGroup[] = [
  {
    ...
    active: true,
    items: [
      { question: 'What is Ghana Lesson Planner?', answer: 'An AI-powered tool that helps Ghanaian teachers create lesson plans, schemes of work, and teaching notes faster.', sortOrder: 1, active: true },
      { question: 'Who is it for?', answer: 'Teachers in Ghanaian basic schools, especially those handling B1 to B9 classes.', sortOrder: 2, active: true },
      { question: 'Which class levels are supported?', answer: 'B1, B2, B3, B4, B5, B6, B7, B8, and B9 are all supported.', sortOrder: 3, active: true },
      { question: 'Is it designed for the Ghana curriculum?', answer: 'Yes. Built around Ghanaian class levels, subjects, terms, lesson structure, and scheme-of-work planning.', sortOrder: 4, active: true },
    ],
  },
  {
    title: 'Lesson Plans',
    ...
    active: true,
    items: [
      { question: 'How does lesson plan generation work?', answer: 'Select class, subject, term, week, and lesson number. Ghana Lesson Planner creates a structured plan based on your selected scheme.', sortOrder: 1, active: true },
  ...
  },
  {
    ...
    active: true,
    items: [
      { question: 'Can Ghana Lesson Planner generate a scheme of work?', answer: 'Yes. It can create a full 12-week scheme for any selected subject, class, and term.', sortOrder: 1, active: true },
  ...
  },
  {
    ...
    items: [
      ...
      { question: 'Are the generated plans always perfect?', answer: 'No AI tool is perfect. Ghana Lesson Planner provides a strong draft; teachers should review before classroom use.', sortOrder: 3, active: true },
    ],
  },
];
