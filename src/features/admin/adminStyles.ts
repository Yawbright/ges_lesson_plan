...
export const styles = StyleSheet.create({
  ...
  codeText: { color: colors.text, fontFamily: 'monospace', fontSize: 12, backgroundColor: '#F7F9F4', padding: 10, borderRadius: 8, marginTop: 8, overflow: 'hidden' },
  pill: {
  ...
  detailItem: { flexGrow: 1, flexBasis: 180, borderWidth: 1, borderColor: colors.border, borderRadius: 8, padding: 10, minWidth: 0, overflow: 'hidden' },
