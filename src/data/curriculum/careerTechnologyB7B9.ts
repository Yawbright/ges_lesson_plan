...
export const careerTechnologyB8Terms: ExplicitCurriculumTerm[] = [
  ...
  },
  {
    ...
    weeks: [
      ...
      week(3, 'Designing and Making of Artefacts/Products', 'Designing', 'B8/JHS2.5.2 Demonstrate knowledge and skills in designing.', 'Write design briefs from observed problem situations.', 'Writing design briefs from problem situations', resources.design),
      week(4, 'Designing and Making of Artefacts/Products', 'Designing', 'B8/JHS2.5.2 Demonstrate knowledge and skills in designing.', 'Research design problems and analyse information gathered.', 'Researching and analysing design problems', resources.design),
      week(5, 'Designing and Making of Artefacts/Products', 'Designing', 'B8/JHS2.5.2 Demonstrate knowledge and skills in designing.', 'Write design specifications and justify them.', 'Writing and justifying design specifications', resources.design),
      week(6, 'Designing and Making of Artefacts/Products', 'Planning for Making Artefacts/Products', 'B8/JHS2.5.3 Demonstrate knowledge and skills in planning for making artefacts/products.', 'Develop production plans and schedules for making products.', 'Production planning and scheduling', resources.design),
      week(7, 'Designing and Making of Artefacts/Products', 'Planning for Making Artefacts/Products', 'B8/JHS2.5.3 Demonstrate knowledge and skills in planning for making artefacts/products.', 'Estimate material needs and sequence of operations.', 'Estimating materials and sequencing operations', resources.design),
      ...
      week(10, 'Entrepreneurial Skills', 'Career Pathways and Career Opportunities', 'B8/JHS2.6.1 Demonstrate understanding of career pathways and opportunities.', 'Explore career opportunities related to practical and technical fields.', 'Exploring career opportunities in practical fields', resources.enterprise),
      week(11, 'Entrepreneurial Skills', 'Establishing and Managing a Small Business Enterprise', 'B8/JHS2.6.2 Demonstrate understanding of establishing and managing micro and small business enterprises.', 'Explain micro, small and medium-sized business enterprises.', 'Micro, small and medium-sized enterprises', resources.enterprise),
      {
        ...
        contentStandard: 'B8/JHS2.6.2 Demonstrate understanding of establishing and managing micro and small business enterprises.',
        indicator: 'Discuss steps in setting up and managing small enterprises; classify known local businesses and reflect on enterprise ideas.',
        ...
        entries: [
          {
            ...
            subStrand: 'Establishing and Managing a Small Business Enterprise',
            contentStandard: 'B8/JHS2.6.2 Demonstrate understanding of establishing and managing micro and small business enterprises.',
            indicator: 'Discuss steps in setting up and managing small enterprises.',
          ...
          },
          {
            ...
            subStrand: 'Establishing and Managing a Small Business Enterprise',
            contentStandard: 'B8/JHS2.6.2 Demonstrate understanding of establishing and managing micro and small business enterprises.',
            indicator: 'Classify known local businesses and reflect on enterprise ideas.',
