export interface GhanaianLanguageExemplarRecord {
  indicator: string;
  exemplars: string[];
  sourcePage: number;
}

export const ghanaianLanguageExemplarsByIndicator: Record<string, GhanaianLanguageExemplarRecord> = {
  "B7.1.1.1.1": {
    indicator: "Identify the processes involved in naming a child.",
    exemplars: [
      "Discuss the outdooring and the naming process of a child in their community. working towards group goals Ghanaian cultures.",
      "Identify the items used in the naming process and write them. E.g.: basket, bucket, beads, basin, mat, powder, lantern, clothes (baby and mother)",
      "Explain the signifi cance of the items used for the naming ceremony. In some communities the outdooring and the naming process are two different things and in other communities the two processes are in one ceremony. xxiv | © NaCCA, Ministry of Education Ghanaian Language _ CCP Curriculum.indd 24 17/11/2020 7:59 PM",
      "Rites of Passage: childhood, puberty, marriage, death and funeral rites ü ü ü ü",
      "Naming Systems: Day names, family names, kinship terms, order of birth, ü ü ü ü circumstantial names, reincarnation, nicknames, insinuation names, etc.",
      "CUSTOMS AND INSTITUTIONS",
      "The Clan System ü ü ü",
      "Chieftaincy: Chieftaincy Installation and destoolment, Traditional ü ü ü ü Government, Judicial Systems (Traditional and Contemporary)",
    ],
    sourcePage: 24,
  },
  "B7.1.1.1.2": {
    ...
    exemplars: [
      ...
      "Discuss a libation text used during naming ceremony.",
      "Write the three main parts of a libation text. 2 | © NaCCA, Ministry of Education Ghanaian Language _ CCP Curriculum.indd 2 17/11/2020 7:59 PM",
    ],
    sourcePage: 28,
  },
  "B7.1.1.1.3": {
  ...
  "B7.1.1.1.5": {
    indicator: "Role play a naming ceremony session in their culture.",
    exemplars: [
      "Role play a naming ceremony among their people.",
      "Discuss the role play and what they have learnt from it.",
    ],
    sourcePage: 29,
  },
  "B7.1.2.1.1": {
  ...
  "B7.1.3.1.2": {
    ...
    exemplars: [
      ...
      "Read a passage on a clan system.",
      "Write the main ideas in the passage read in their own words. 6 | © NaCCA, Ministry of Education Ghanaian Language _ CCP Curriculum.indd 6 17/11/2020 7:59 PM",
    ],
    sourcePage: 32,
  },
  "B7.1.4.1.1": {
    ...
    exemplars: [
      ...
      "Relate how chiefs and queenmothers are selected among their people to the passage read.",
    ],
    sourcePage: 33,
  },
  "B7.1.4.1.2": {
    ...
    exemplars: [
      ...
      "Identify those who select the chief and queenmother among your people. NB: Some cultures of Ghana do not have queenmothers.",
    ],
    sourcePage: 33,
  },
  "B7.1.4.1.3": {
  ...
  "B7.1.4.1.4": {
    ...
    exemplars: [
      ...
      "Compare the modern ways of enstooling/enskinning chiefs/ queenmothers with the traditional ways of enstooling/enskinning chiefs/ queenmothers. 8 | © NaCCA, Ministry of Education Ghanaian Language _ CCP Curriculum.indd 8 17/11/2020 7:59 PM",
    ],
    sourcePage: 34,
  },
  "B7.2.1.1.1": {
    ...
    exemplars: [
      ...
      "Identify informal situations: E.g. casual or intimate relationship between friends and acquaintances, family and team mates, etc.",
      "Use appropriate language to participate in conversations in the following situations: Greetings,requests, encouragements, partings, etc. (Examples of informal language include slang words, jargons, contracted forms, non-verbal communication)",
    ],
    sourcePage: 35,
  },
  "B7.2.1.1.2": {
  ...
  "B7.2.1.1.5": {
    ...
    exemplars: [
      ...
      "Engage in conversation using the right tone and maintaining eye contact. Monitor how your partner shows this in the conversation. 10 | © NaCCA, Ministry of Education Ghanaian Language _ CCP Curriculum.indd 10 17/11/2020 7:59 PM",
    ],
    sourcePage: 36,
  },
  "B7.2.3.1.1": {
    indicator: "Identify and produce the vowels in their language.",
    exemplars: [
    ],
    sourcePage: 38,
  },
  "B7.2.3.1.2": {
    indicator: "Identify and produce the consonants in their language.",
    exemplars: [
      "Identify consonants in words.",
      "Produce the conso.nant sounds of your language. E.g. /b/, /f/, /g/. etc.",
      "Record the consonant sounds of your language.",
      "Pronounce consonant sounds correctly and fluently in connected speech.",
    ],
    sourcePage: 38,
  },
  "B7.2.3.1.3": {
    ...
    exemplars: [
      ...
      "Read four syllable words",
      "Pronounce polysyllabic words correctly and fluently in connected speech. © NaCCA, Ministry of Education | 13 Ghanaian Language _ CCP Curriculum.indd 13 17/11/2020 7:59 PM",
    ],
    sourcePage: 38,
  },
  "B7.2.4.1.1": {
    indicator: "Identify and produce the basic tones in their language.",
    exemplars: [
      "Identify the tones on syllables in their language. E.g.: low, high, and mid.",
      "Pronounce words with tones correctly and fluently in connected speech.",
      "Use the knowledge of tone to pronounce same words that have different tones in context. STRAND 2: B7.2 LISTENING AND SPEAKING SUB-STRAND 5: B7.2.5 VOCABULARY DEVELOPMENT (SIGHT AND CONTENT VOCABULARY) CONTENT STANDARD INDICATORS AND EXEMPLARS",
    ],
    sourcePage: 40,
  },
  "B7.2.5.1.1": {
    ...
    exemplars: [
      ...
      "Use the vocabularies identified to form meaningful sentences. 14 | © NaCCA, Ministry of Education Ghanaian Language _ CCP Curriculum.indd 14 17/11/2020 7:59 PM",
    ],
    sourcePage: 40,
  },
  "B7.2.6.1.1": {
    ...
    exemplars: [
      ...
      "Converse with others about daily activities.",
      "Make a presentation on other familiar topics, e.g. family, school, holidays, weather, hobbies, animals, hometown or village, favourite time of the year and festival. © NaCCA, Ministry of Education || 1155 Ghanaian Language _ CCP Curriculum.indd 15 17/11/2020 7:59 PM",
    ],
    sourcePage: 41,
  },
  "B7.3.1.1.1": {
    ...
    exemplars: [
      ...
      "Explain the relationship between the main ideas and supporting ideas.",
      "Answer recall and inferential questions concerning the text read.",
    ],
    sourcePage: 42,
  },
  "B7.3.1.1.2": {
    ...
    exemplars: [
      ...
      "Summarise a passage of about one hundred and fifty words in fifty words using your own words. 16 | © NaCCA, Ministry of Education Ghanaian Language _ CCP Curriculum.indd 16 17/11/2020 7:59 PM",
    ],
    sourcePage: 42,
  },
  "B7.3.2.1.1": {
    indicator: "Translate words and phrases in his/her language.",
    exemplars: [
      "Translate given words and simple phrases from the source language to a simple sentences target language.",
      "Translate phrases simple sentences from the source language of study to persuasive, imaginative and expository a target language. purposes.",
      "Translate simple sentences from the source language to a target language. © NaCCA, Ministry of Education || 1177 Ghanaian Language _ CCP Curriculum.indd 17 17/11/2020 7:59 PM",
    ],
    sourcePage: 43,
  },
  "B7.4.1.1.1": {
    indicator: "Discuss the components of sentences.",
    exemplars: [
      "Explain what a sentence is. the components of",
      "Give examples of sentences and their component parts in their language. with relevant detail, using construction and",
      "Discuss the components of a sentence in their language. structure of speech.",
    ],
    sourcePage: 44,
  },
  "B7.4.1.1.2": {
    ...
    exemplars: [
      ...
      "Identify the components of a complex sentence in your language and give examples.",
    ],
    sourcePage: 44,
  },
  "B7.4.1.1.3": {
  ...
  "B7.4.2.1.1": {
    ...
    exemplars: [
      ...
      "Pronounce the nouns and use them correctly in speech and texts. and passages",
      "Construct simple and compound sentences(orally and in written forms) with the types of nouns identified.",
    ],
    sourcePage: 45,
  },
  "B7.4.2.1.2": {
    ...
    exemplars: [
      ...
      "Construct sentences with the types of pronouns in speaking and writing individually and in mixed ability groups.",
      "Replace nouns with the appropriate pronoun in a passage.",
    ],
    sourcePage: 45,
  },
  "B7.4.2.1.3": {
    ...
    exemplars: [
      ...
      "Use the adjectives to form simple and compound sentences in speaking and writing. © NaCCA, Ministry of Education || 1199 Ghanaian Language _ CCP Curriculum.indd 19 17/11/2020 7:59 PM",
    ],
    sourcePage: 45,
  },
  "B7.4.3.1.1": {
    indicator: "Identify and classify verbs into their types.",
    exemplars: [
      "Identify and use verbs appropriately and correctly in passages and in",
      "Categorise the verbs into types and use them to construct simple and compound sentences.",
    ],
    sourcePage: 46,
  },
  "B7.4.3.1.2": {
    indicator: "Identify and classify adverbs into their various types.",
    exemplars: [
      "Identify and use adverbs appropriately and correctly in simple sentences",
      "Categorise the verb into types and use them to construct simple and compound sentences in speaking and writing individually and in mixed ability groups.",
    ],
    sourcePage: 46,
  },
  "B7.4.3.1.3": {
  ...
  "B7.4.4.1.2": {
    indicator: "Spell words related to home and school correctly.",
    exemplars: [
      "Write down vocabulary items related to home and school dictated",
      "Construct sentences with the vocabulary items written down.",
    ],
    sourcePage: 48,
  },
  "B7.4.4.1.3": {
  ...
  "B7.5.1.1.1": {
    indicator: "Discuss the features of a paragraph.",
    exemplars: [
      "Ability to write the topic and supporting sentences of a paragraph.",
      "Develop the skills of expressing and organising ideas in paragraphs. persuasive, imaginative and expository types (narrative,",
      "Identify the salient points/ideas in a given paragraph. purposes descriptive, creative/free",
      "Write a paragraph of about fifty words on a given topic taking into writing) consideration the features and skills of paragraph writing.",
    ],
    sourcePage: 49,
  },
  "B7.5.1.1.2": {
  ...
  "B7.6.1.1.1": {
    indicator: "Discuss the components of literature.",
    exemplars: [
      "Discuss the characteristics of literature.",
      "Classify literature into types.",
      "Give examples and relate to the types",
      "Develop the skills of appreciating and analysing literary texts.",
    ],
    sourcePage: 50,
  },
  "B7.6.1.1.2": {
    ...
    exemplars: [
      ...
      "Analyse a folktale and a song.",
      "Appreciate the significance of a folktale and a song.",
    ],
    sourcePage: 50,
  },
  "B7.6.1.1.3": {
    ...
    exemplars: [
      ...
      "Explore ways that writers use literary devices, mood and tone in a range of prose, poetry and drama texts. 24 | © NaCCA, Ministry of Education Ghanaian Language _ CCP Curriculum.indd 24 17/11/2020 7:59 PM",
    ],
    sourcePage: 50,
  },
  "B8.1.1.1.1": {
    ...
    exemplars: [
      ...
      "Discuss the processes involved in performing puberty rites for boys/girls among their people.",
      "Read and discuss a two-hundred-word passage on puberty rites.",
      "Explain the significance of puberty rites.",
      "Role play a puberty rite activity.",
    ],
    sourcePage: 52,
  },
  "B8.1.1.1.2": {
    ...
    exemplars: [
      ...
      "Write the summary of the similarities and differences. 26 | © NaCCA, Ministry of Education Ghanaian Language _ CCP Curriculum.indd 26 17/11/2020 7:59 PM",
    ],
    sourcePage: 52,
  },
  "B8.1.1.1.3": {
    ...
    exemplars: [
      ...
      "Identify the threats to puberty rites in contemporary times. E.g.: technology, migration, education and religion © NaCCA, Ministry of Education | 27 Ghanaian Language _ CCP Curriculum.indd 27 17/11/2020 7:59 PM",
    ],
    sourcePage: 53,
  },
  "B8.1.2.1.1": {
    ...
    exemplars: [
      ...
      "Discuss the importance of family names.",
      "Make a documentation on family names for male and female and indicate their sources. B8.1.2.1 Recognise",
    ],
    sourcePage: 54,
  },
  "B8.1.2.1.2": {
    indicator: "Examine kinship terms in their community.",
    exemplars: [
      "Read a passage (200 words) on kinship terms. and proverbial and",
      "Cite the kinship terms that are used to address your family members. working towards group goals. E. g. father, mother, uncle, aunt, niece, nephew, grandparents, etc.",
      "Discuss and document the importance of kinship terms. 28 | © NaCCA, Ministry of Education Ghanaian Language _ CCP Curriculum.indd 28 17/11/2020 7:59 PM",
    ],
    sourcePage: 54,
  },
  "B8.1.2.1.3": {
  ...
  "B8.1.2.1.4": {
    indicator: "Discuss proverbial and insinuation names.",
    exemplars: [
      "Explain proverbial and insinuation names. and proverbial and",
      "Discuss the characteristics of proverbial and insinuation names. working towards group goals. E..g. They are one-word names that represent whole sentences.",
      "Identify situations that lead to proverbial and insinuation names. traditions, values and attitudes of society. E..g. To cast insinuations. To show appreciation © NaCCA, Ministry of Education | 29 Ghanaian Language _ CCP Curriculum.indd 29 17/11/2020 7:59 PM",
      "Give examples of proverbial and insinuation names used among your and understand family people. E.g.: names, kinship terms • Akan: Obimpɛ, Obinim. and proverbial and • Gonja: Dukulubi, Ndefoso. insinuation names • Dagaare: Dɔmɔnaaŋmene, Kannyiri • Dangme: Koodimɛ, Zogbemɛ • Ga: Ayeayeefɛɛ, Kaajɛmi. • Ewe: Akpeleasi, Aɖukonu, Dɔmelevo. • Nzema: Bɛzenɛ, Ɛkpɔlɛgyɛne • Dagbani: Mbaŋba, Bɛjema. • Kasem: Ayerjoa, Ajoawora.",
    ],
    sourcePage: 55,
  },
  "B8.1.2.1.5": {
    indicator: "Explore and discuss appellations that go with names.",
    exemplars: [
      "Explain appellation.",
      "Give examples of day names and their appellations. working towards group goals. • E.g.",
      "Identify and discuss appellations that go with family and other names and understand family where applicable. names, kinship terms • E.g. and proverbial and insinuation names People Name Appellation • Akan: • Asante: • Korɔbea • Dangme • Tɛtɛ • Ogbetee • Ewe: • Xɔɖasi • Menyeametɔ o • Gonja • Awari • Janjina • Ga: • Lante • Okuŋka • Dagbani: • Andani • Dandani • Nzema • Awɔkɛ • Ɛkyelebenle © NaCCA, Ministry of Education | 31 Ghanaian Language _ CCP Curriculum.indd 31 17/11/2020 7:59 PM",
    ],
    sourcePage: 56,
  },
  "B8.1.3.1.1": {
    indicator: "Discuss the importance and threats to the clan system.",
    exemplars: [
      "Read and discuss a passage on clan system of their culture. by discussing the",
      "Discuss and write the importance of the clan system of their culture. working towards group goals. to the clan systems",
      "Discuss the threats to the clan system.",
    ],
    sourcePage: 58,
  },
  "B8.1.4.1.1": {
  ...
  "B8.1.4.1.2": {
    ...
    exemplars: [
      ...
      "Role play destoolment/deskinment of a chief among their people. © NaCCA, Ministry of Education || 3333 Ghanaian Language _ CCP Curriculum.indd 33 17/11/2020 7:59 PM",
    ],
    sourcePage: 59,
  },
  "B8.1.4.1.3": {
  ...
  "B8.2.1.1.1": {
    ...
    exemplars: [
      ...
      "Draw and discuss a scenery on a given topic (e.g.: fishing, farming, weaving, etc.).",
      "Describe a visit to a hospital.",
      "Describe a scene at a lorry station. STRAND 2: B8.2 LISTENING AND SPEAKING SUB-STRAND 2: B8.2.2 LISTENING COMPREHENSION CONTENT STANDARD INDICATORS AND EXEMPLARS",
    ],
    sourcePage: 61,
  },
  "B8.2.2.1.1": {
  ...
  "B8.2.4.1.1": {
    ...
    exemplars: [
      ...
      "Pronounce words with low tone.",
      "Read same words with different tone in context. context appropriately.",
      "State the differences of those words as used in context. STRAND 2: B8.2 LISTENING AND SPEAKING SUB-STRAND 6: B8.2.6 PRESENTATION — EVERYDAY EXPERIENCE CONTENT STANDARD INDICATORS AND EXEMPLARS",
    ],
    sourcePage: 62,
  },
  "B8.2.6.1.1": {
    ...
    exemplars: [
      ...
      "Draw and discuss a scenery on a given topic (e.g.: fishing, farming, weaving, etc.).",
      "Describe a visit to the hospital.",
      "Describe a scene at a lorry station. 36 | © NaCCA, Ministry of Education Ghanaian Language _ CCP Curriculum.indd 36 17/11/2020 7:59 PM",
    ],
    sourcePage: 62,
  },
  "B8.3.1.1.1": {
  ...
  "B8.3.1.1.2": {
    indicator: "Summarise long passages read.",
    exemplars: [
      "Read longer texts and summarise main and supporting ideas.",
    ],
    sourcePage: 63,
  },
  "B8.3.2.1.1": {
  ...
  "B8.4.2.1.1": {
    ...
    exemplars: [
      ...
      "Construct compound sentences with nouns and pronouns in speech and in texts.",
      "Replace nouns with the appropriate pronouns in a given text.",
    ],
    sourcePage: 64,
  },
  "B8.4.2.1.2": {
  ...
  "B8.4.3.1.2": {
    indicator: "Identify and use adverbs appropriately in sentences.",
    exemplars: [
      "Determine the functions of adverbs in sentences.",
      "Identify and classify adverbs in a given text. and structure of speech.",
      "Construct compound sentences using adverbs.",
    ],
    sourcePage: 65,
  },
  "B8.4.3.1.3": {
  ...
  "B8.6.1.1.1": {
    ...
    exemplars: [
      ...
      "State the occasions and situations in which the given proverbs and",
      "State the importance of proverbs and idioms. B8.6.1.2 Demonstrate",
    ],
    sourcePage: 67,
  },
  "B8.6.1.2.1": {
    ...
    exemplars: [
      ...
      "Discuss the ways writers use language to create settings for different effects in prose, poetry and drama.",
      "Discuss how writers use language to create mood and tone in prose, poetry and drama",
      "Discuss the ways writers structure texts in prose, poetry and drama. © NaCCA, Ministry of Education || 4411 Ghanaian Language _ CCP Curriculum.indd 41 17/11/2020 7:59 PM",
    ],
    sourcePage: 67,
  },
  "B9.1.1.1.1": {
    ...
    exemplars: [
      ...
      "Identify some of the marriage rites in their culture and write them.",
      "Discuss marriage rites performance.",
      "Explore the significance of the processes involved in performing marriage rites.",
    ],
    sourcePage: 70,
  },
  "B9.1.1.1.2": {
  ...
  "B9.1.1.1.3": {
    ...
    exemplars: [
      ...
      "Dramatise marriage rites session of their culture. traditions, values and attitudes of society. 44 | © NaCCA, Ministry of Education Ghanaian Language _ CCP Curriculum.indd 44 17/11/2020 7:59 PM",
    ],
    sourcePage: 70,
  },
  "B9.1.2.1.1": {
    ...
    exemplars: [
      ...
      "Discuss the significance of circumstantial names.",
    ],
    sourcePage: 71,
  },
  "B9.1.2.1.2": {
    indicator: "Discuss reincarnation names and their meanings.",
    exemplars: [
      "Identify reincarnation names and discuss their meanings.",
      "Discuss the significance of reincarnation names. ideas, organisation, voice, word choice and sentence fluency in communication.",
    ],
    sourcePage: 71,
  },
  "B9.1.2.1.3": {
    indicator: "Identify and discuss deity names.",
    exemplars: [
      "Explain circumstances that lead to giving new borns deity names. and application",
      "Discuss the significance of deity names. 46 | © NaCCA, Ministry of Education Ghanaian Language _ CCP Curriculum.indd 46 17/11/2020 7:59 PM",
    ],
    sourcePage: 72,
  },
  "B9.1.3.1.1": {
    indicator: "Discuss trends affecting the clan system.",
    exemplars: [
      "Identify and discuss the trends affecting the clan system. Citizenship (CG) knowledge of the factors",
      "Discuss ways by which the clan system can be strengthened. that militate against the ideas, organisation, voice, word choice and clan system",
      "Discuss the similarities and differences between the various clan systems sentence fluency in communication. in their locality.",
    ],
    sourcePage: 73,
  },
  "B9.1.4.1.1": {
    ...
    exemplars: [
      ...
      "Discuss and write down the duties of the functionaries.",
      "Discuss and write the importance of the functionaries. makers) of their society and their duties. © NaCCA, Ministry of Education || 4477 Ghanaian Language _ CCP Curriculum.indd 47 17/11/2020 7:59 PM",
    ],
    sourcePage: 73,
  },
  "B9.2.1.1.1": {
    ...
    exemplars: [
      ...
      "Create and act scenes on texts/issues/topics using both formal and informal register to distinguish characters.",
    ],
    sourcePage: 74,
  },
  "B9.2.1.1.2": {
    ...
    exemplars: [
      ...
      "Engage in conversations on topics/issues with several speakers and respond to different views. 48 | © NaCCA, Ministry of Education Ghanaian Language _ CCP Curriculum.indd 48 17/11/2020 7:59 PM",
    ],
    sourcePage: 74,
  },
  "B9.2.1.1.3": {
  ...
  "B9.2.2.1.2": {
    ...
    exemplars: [
      ...
      "Engage in conferences to discuss ideas noted from texts/speeches/ dialogues and express their own clearly and persuasively 50 | © NaCCA, Ministry of Education Ghanaian Language _ CCP Curriculum.indd 50 17/11/2020 7:59 PM",
    ],
    sourcePage: 76,
  },
  "B9.2.4.1.1": {
    ...
    exemplars: [
      ...
      "Read a passage using the correct tone patterns to depict the right context. STRAND 2: B9.2 LISTENING AND SPEAKING SUB-STRAND 4:B9.2.6 PRESENTATION: EVERYDAY EXPERIENCES CONTENT STANDARD INDICATORS AND EXEMPLARS",
    ],
    sourcePage: 77,
  },
  "B9.2.6.1.1": {
    indicator: "Discuss complex topics related to everyday activities.",
    exemplars: [
      "Read a text on deforestation in Ghana, same sex marriage, insecurity, etc. . topics using appropriate",
      "Discuss some of the everyday activities in the factory, traditional implications and issues when listening. occupational shops, settlement of cases at the palace, etc.",
    ],
    sourcePage: 77,
  },
  "B9.2.6.1.2": {
    indicator: "Compose their own group report on some topical issues.",
    exemplars: [
      "Develop their own report on a range of suitable familiar and unfamiliar,",
      "Make a presentation on the topics above to the class for discussion. © NaCCA, Ministry of Education || 5511 Ghanaian Language _ CCP Curriculum.indd 51 17/11/2020 7:59 PM",
    ],
    sourcePage: 77,
  },
  "B9.3.1.1.1": {
    ...
    exemplars: [
      ...
      "Rewrite the ideas logically in their own words.",
      "Answer recall, meaning and inferential questions based on the passage.",
    ],
    sourcePage: 78,
  },
  "B9.3.1.1.2": {
    indicator: "Summarise passages read in given number of sentences.",
    exemplars: [
      "Arrange the main ideas in a range of passages logically and coherently.",
      "Summarise a passage of two hundred words in fifty words.",
    ],
    sourcePage: 78,
  },
  "B9.3.2.1.1": {
  ...
  "B9.4.2.2.1": {
    indicator: "Discuss how adjectives follow each other in a sentence.",
    exemplars: [
      "Identify adjectives in texts.",
      "Form sentences with two or three adjectives. © NaCCA, Ministry of Education || 5533 Ghanaian Language _ CCP Curriculum.indd 53 17/11/2020 7:59 PM",
    ],
    sourcePage: 79,
  },
  "B9.4.3.1.1": {
    indicator: "Discuss auxiliary verbs in sentences.",
    exemplars: [
      "Identify types of verbs in a recorded/read passage.",
      "Discuss auxiliary verbs (where applicable).",
      "Construct sentences with auxiliary verbs. B9.4.3.2 Demonstrate",
    ],
    sourcePage: 80,
  },
  "B9.4.3.1.3": {
    indicator: "Discuss how adverbs follow each other in a sentence.",
    exemplars: [
      "Identify adverbs in texts.",
      "Construct sentences with two or three adverbs correctly. STRAND 5: B9.5 COMPOSITION WRITING SUB-STRAND 1: B9.5.1 STRUCTURE AND ORGANISE IDEAS IN COMPOSITION WRITING CONTENT STANDARD INDICATORS AND EXEMPLARS",
    ],
    sourcePage: 80,
  },
  "B9.5.1.1.1": {
  ...
  "B9.6.1.1.1": {
    ...
    exemplars: [
      ...
      "Discuss the occasions/situations on/in which drum language/appellation is cultures. used.",
      "State the importance of drum language/appellation.",
      "Appreciate war songs in your language.",
      "Discuss the importance of war songs. B9.6.1.2 Demonstrate",
    ],
    sourcePage: 81,
  },
  "B9.6.1.2.1": {
    ...
    exemplars: [
      ...
      "Discuss how writers use settings to create different effects in a range of prose, poetry and drama.",
      "Discuss how writers use language to create mood and tone in an increasing range of prose, poetry and drama",
      "Discuss the ways writers structure texts in a range of prose, poetry and drama texts. © NaCCA, Ministry of Education || 5555 Ghanaian Language _ CCP Curriculum.indd 55 17/11/2020 7:59 PM",
      "Read and discuss a text on death.",
      "Discuss and write the types of death with other cultures of",
      "Explore the causes of the different types of death. Ghana",
    ],
    sourcePage: 81,
  },
};
